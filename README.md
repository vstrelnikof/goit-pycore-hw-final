...
Консольний застосунок для керування контактами та нотатками: два режими інтерфейсу (TUI на asciimatics і класичний текстовий), збереження даних у JSON, профілі користувачів, валідація полів і вгадування команд.
